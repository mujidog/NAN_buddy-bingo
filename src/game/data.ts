...
export const WORDS: Record<Round, readonly WordTuple[]> = {
  ...
  3: [
    ...
    ['cold', '차가운', '응? 춥다고? 이상하다,내 뱃속은 따뜻한데! 봐, 네 손끝도 벌써 녹고 있잖아.'],
    ['crying', '우는 소리', '우는 소리가 들려서 봤더니… 왜 우는 거야? 아까운 눈이 흘러내리고 있잖아.'],
    ['mistake', '실수', '그니까 그건 실수였어… 나도 더 오래 놀고 싶었다고!'],
    ['below', '아래에', '아래를 봐! 쑤셔 담은 애정이 피부 아래에서 꿈틀거리는게 느껴져?'],
    ...
    ['unseen', '보이지 않는', '보이지 않는 게 들린다면, 숨 넘어갈 듯한 노래로 화답해줘! 아주 기뻐할 거야!'],
    ['draw', '그리다', '같이 그림을 그리자! 붉은색은 네 평생 부족하지 않을거야!'],
...
export const ROUND_RULES: Partial<Record<Round, readonly string[]>> = {
  ...
  3: [
    ...
    '누르면… 하트를 반쪽 가져갈 거야. 그 칸은 다시 못 쓰고.',
